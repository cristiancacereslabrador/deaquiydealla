    ...
    <footer className="mt-auto border-t border-border/60 bg-muted/40">
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              La fusión perfecta entre la tradición china y el corazón latino. 
              Sabor que une continentes en cada plato.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="font-bold text-lg">Pídenos a domicilio</h3>
            <p className="text-sm text-muted-foreground">
              ¿Prefieres que te lo llevemos? Encuéntranos en Glovo.
            </p>
            <a 
            ...
            >
              Pedir en Glovo <ExternalLink className="w-4 h-4" />
            </a>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-border/40 flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-muted-foreground">
          <p>© {year} {BRAND_INFO.name}. Todos los derechos reservados.</p>
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
             <p>Cerrado los Jueves</p>
             <a 
